    ...
    public List<NewBeeMallIndexCategoryVO> getCategoriesForIndex() {
        ...
        if (!CollectionUtils.isEmpty(firstLevelCategories)) {
            ...
            if (!CollectionUtils.isEmpty(secondLevelCategories)) {
                ...
                Map<Long, List<GoodsCategory>> thirdLevelCategoryMap = new HashMap<>();
                if (!CollectionUtils.isEmpty(thirdLevelCategories)) {
                    //根据 parentId 将 thirdLevelCategories 分组
                    thirdLevelCategoryMap = thirdLevelCategories.stream().collect(groupingBy(GoodsCategory::getParentId));
                }
...
//                        }
                ...
                //处理一级分类
                Map<Long, List<SecondLevelCategoryVO>> secondLevelCategoryVOMap = new HashMap<>();
                if (!CollectionUtils.isEmpty(secondLevelCategoryVOS)) {
                    //根据 parentId 将 thirdLevelCategories 分组
                    secondLevelCategoryVOMap = secondLevelCategoryVOS.stream().collect(groupingBy(SecondLevelCategoryVO::getParentId));
                }
